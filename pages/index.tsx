...
import Scene from "@components/astro/Scener";
      ...
      <div className="bg-[#161616] pb-20">
        <Content>
          <PageStart
            ...
            title={
              <span>
                Bygger <WordCircled borderCircle={false}>skalbart</WordCircled>
                {t(" med Amazon Web Services i ")}
                <WordCircled borderCircle={true}>Stockholm</WordCircled>.
              </span>
            }
          ></PageStart>
        </Content>
        ...
        <div className={bgLight}>
          ...
          <div className="grid grid-cols-12 py-32 md:py-56 text-white">
            <div className="md:col-start-4 text-xl md:col-span-6 col-start-2 col-span-10 mt-4 text-center">
              ...
              <div className="flex justify-around pt-24 gap-2">
                <Image
                  alt=""
                  width={100}
                  height={100}
                  src={"/images/icons/Icon-49.svg"}
                ></Image>
              </div>
            </div>
          </div>
        ...
        <Content>
          <div className="md:mt-52 mt-32 mb-40">
            <div className="md:hidden relative text-white mb-10">
              <h3 className="text-xs">{t("Rekommendationer")}</h3>
            ...
            >
              <div className="hidden md:block relative">
                ...
                <p className="mt-10 text-lg">{t("Rekommendationer")}</p>
                <p className="text-xs">
                  {t("Läs vad några av våra grymma kunder har att säga!")}
                </p>
              </div>
