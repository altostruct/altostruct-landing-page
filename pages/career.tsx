    ...
    <div className="bg-[#161616] md:pb-20 pb-10">
      <Content>
        <div className="mb-6 items-center md:text-left text-center text-white md:w-3/4">
          <p className="pt-20 md:pt-48 mt-9 text-3xl md:text-6xl text-left md:w-3/4">Lorem <WordCircled borderCircle={true}>Lorem</WordCircled> dolor sit amet adipisicing elit lorem <WordCircled>Lorem</WordCircled> dolor sit amet <WordCircled borderCircle={true}>Lorem</WordCircled></p>
