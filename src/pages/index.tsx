    ...
    <main className="page">
        ...
        <div className="split-content">
          <CardStack
            ...
            cards={[
              ...
              {
                description: "Framtidssäkra med ett modernt ramverk",
                image:
                  "https://logos-download.com/wp-content/uploads/2016/09/Node_logo_NodeJS.png",
                title: "Node.js",
              },
              {
                description: "Bygg din plattform med senaste cloudteknologin",
                image:
      ...
      >
        <div className="center-content cols mark">
          <div>
            <p className="no-break">Använda teknologier</p>
