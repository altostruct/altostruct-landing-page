...
const Button = (props: ButtonProps) => {
    ...
    return <a href={link} onClick={onClick} className={classNames("py-1 whitespace-nowrap text-lg gap-4 border-4 border-black cursor-pointer text-center flex px-8", className, {
