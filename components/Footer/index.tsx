    ...
    return (
        <div>
            ...
            <div className="flex gap-2">
                <a href="https://www.linkedin.com/company/altostruct/">
...
const Footer = () => {
    return <div className="w-screen mt-32 bg-black">
        <Content className="py-12 text-gray-200">
            <Row className="divide-x-4 divide-dashed">
                <div className="flex-1 ">
                    <p className=" text-6xl underline pb-8">
                        Senaste nyheter
                    </p>
                    <p className=" text-6xl underline pb-8">
                        Kontakta oss
                ...
                <div className="px-10">
                    <p>Altostruct är ett konsultbolag grundat 2020. Vi erbjuder </p>
                </div>
            </Row>

            <div className="h-[4px] w-full my-10  bg-white "></div>
            <Row>
                <div className="flex-1 ">
                    <p className="text-lg">Organisation nummer:</p>
                    <p className="text-lg">email: info@altostruct.se</p>
